...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['agregar_producto']) || isset($_POST['editar_producto'])) {
        ...
        if ($cantidad > $cantidad_maxima) {
            $_SESSION['mensaje'] = "La cantidad debe estar entre $cantidad_minima y $cantidad_maxima.";
...
$productos_por_pagina = 10; // Cambia a 10 productos por página depende de como se me haga mas bonito
...
<body>
                    ...
                    <form id="userForm" action="inventario.php" method="POST">
                        ...
                        <div class="input-group">
                            ...
                            <select name="role" id="role" required>
                                ...
                                <option value="read_only">Usuario/Lectura</option>
                            </select>
                        </div>
    ...
    <script>
    // Función para abrir el modal de producto y preparar el formulario para agregar un nuevo producto
    function openProductModal() {
    // Mostrar el modal de producto
    document.getElementById('productModal').style.display = 'block';
    // Reiniciar el formulario de producto
...
function closeProductModal() {
    // Ocultar el modal de producto
    document.getElementById('productModal').style.display = 'none';
}

// Función para abrir el modal de usuario y preparar el formulario para agregar un nuevo usuario
function openUserModal() {
    // Mostrar el modal de usuario
    document.getElementById('userModal').style.display = 'block';
    // Reiniciar el formulario de usuario
...
// Función para abrir el modal de lista de usuarios
function openUserListModal() {
    // Mostrar el modal de lista de usuarios
    document.getElementById('userListModal').style.display = 'block';
}

// Función para cerrar el modal de lista de usuarios
function closeUserListModal() {
    // Ocultar el modal de lista de usuarios
    document.getElementById('userListModal').style.display = 'none';
}

// Función para abrir el modal de cambio de contraseña
function openChangePasswordModal(userId) {
    // Asignar el ID del usuario al campo oculto en el formulario de cambio de contraseña
...
function closeChangePasswordModal() {
    // Ocultar el modal de cambio de contraseña
    document.getElementById('changePasswordModal').style.display = 'none';
}

// Función para abrir el modal de historial de modificaciones
function openHistoryModal() {
    // Mostrar el modal de historial de modificaciones
    document.getElementById('historyModal').style.display = 'block';
}

// Función para cerrar el modal de historial de modificaciones
function closeHistoryModal() {
    // Ocultar el modal de historial de modificaciones
    document.getElementById('historyModal').style.display = 'none';
}

// Función para abrir el modal de producto y preparar el formulario para editar un producto existente
